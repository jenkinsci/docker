...
RUN apt-get update && apt-get install -y git curl ruby-full rubygems build-essential zip && rm -rf /var/lib/apt/lists/* && gem update --system && gem install sass && gem install compass
