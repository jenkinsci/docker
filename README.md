...
[![Docker Stars](https://img.shields.io/docker/stars/codenest/jenkins.svg)](https://hub.docker.com/r/codenest/jenkins/)
[![Docker Pulls](https://img.shields.io/docker/pulls/codenest/jenkins.svg)](https://hub.docker.com/r/codenest/jenkins/)
...
```
docker run -p 8080:8080 -p 50000:50000 codenest/jenkins:lts
```
...
```
docker run -p 8080:8080 -p 50000:50000 -v jenkins_home:/var/jenkins_home codenest/jenkins:lts
```
...
```
docker run -d -v jenkins_home:/var/jenkins_home -p 8080:8080 -p 50000:50000 codenest/jenkins:lts
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --env JAVA_OPTS=-Dhudson.footerURL=http://mycompany.com codenest/jenkins:lts
```
...
EOF
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --env JAVA_OPTS="-Djava.util.logging.config.file=/var/jenkins_home/log.properties" -v `pwd`/data:/var/jenkins_home codenest/jenkins:lts
```
...
```
docker run codenest/jenkins:lts --version
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50001:50001 --env JENKINS_SLAVE_AGENT_PORT=50001 codenest/jenkins:lts
```
...
* `JENKINS_WAR`: full path to the jenkins.war. Default value: `/usr/share/codenest/jenkins.war`
