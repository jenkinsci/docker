...
make build-debian_jdk21 # or build-alpine_jdk21 build-debian_slim_jdk21 build-debian_jdk21 ...
...
make test-debian_jdk21 # or test-alpine_jdk21 test-debian_slim_jdk21 test-debian_jdk21 ...

## Run tests for Alpine Linux JDK21 platform in sequential mode
DISABLE_PARALLEL_TESTS=true make test-alpine_jdk21
  ...
  "target": {
    "debian_jdk25": {
      ...
      "args": {
        ...
        "DEBIAN_VARIANT": "",
        "DEBIAN_VERSION": "20260406",
        "JAVA_VERSION": "25.0.2_10",
        "JENKINS_VERSION": "2.541.3",
        "PLUGIN_CLI_VERSION": "2.14.0",
        "WAR_URL": "https://get.jenkins.io/war-stable/2.541.3/jenkins.war"
      },
      "tags": [
        "docker.io/jenkins/jenkins:2.541.3-jdk25",
        "docker.io/jenkins/jenkins:lts-jdk25",
        "docker.io/jenkins/jenkins:2.541.3-lts-jdk25"
      ],
      "platforms": [
        "linux/amd64",
        "linux/arm64",
