...
build-debian:
	docker build -t jenkins-docker:debian-jdk8 --file 8/debian/buster/hotspot/Dockerfile .

build-alpine:
	docker build -t jenkins-docker:alpine-jdk8 --file 8/alpine/hotspot/Dockerfile .

build-slim:
	docker build -t jenkins-docker:slim-jdk8 --file 8/debian/buster-slim/hotspot/Dockerfile .

build-jdk11:
	docker build -t jenkins-docker:debian-jdk11 --file 11/debian/buster/hotspot/Dockerfile .

build-centos:
	docker build -t jenkins-docker:centos-jdk8 --file 8/centos/centos8/hotspot/Dockerfile .

build-centos7:
	docker build -t jenkins-docker:centos7-jdk8 --file 8/centos/centos7/hotspot/Dockerfile .

build-openj9:
	docker build -t jenkins-docker:ubuntu-openj9-jdk8 --file 8/ubuntu/bionic/openj9/Dockerfile .

build-openj9-jdk11:
	docker build -t jenkins-docker:ubuntu-openj9-jdk11 --file 11/ubuntu/bionic/openj9/Dockerfile .
